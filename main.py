# from secrets import env except ImportError:
import secrets
import logging
...
if "TELEGRAM BOT TOKEN" in environ:
    ...
    if "TWITTER_ACCESS_TOKEN" in environ:
        ...
        env = dict(
            ...
            TWITTER_CONSUMER_KEY=environ.get("TWITTER_ CONSUMER KEY"),
            TWITTER_CONSUMER_SECRET=environ.get("TWITTER_ CONSUMER_SECRET"),
        ...
        env = dict(
            TELEGRAM_BOT_TOKEN=environ. get("TELEGRAM_BOT_ TOKEN"),
    ...
    try:
        ...
        print("""CONFIGURATION ERROR: missing secrets.py!
